        ...
        <div className="divide-y">
          ...
          <div className="grid grid-cols-6 p-4 items-center">
            ...
            <div className="col-span-1 flex border px-2 items-center w-[110px] py-1 rounded-lg">
              ...
              >
                <path
                  d="M6.75 12C3.4362 12 0.75 9.3138 0.75 6C0.75 2.6862 3.4362 0 6.75 0C10.0638 0 12.75 2.6862 12.75 6C12.75 9.3138 10.0638 12 6.75 12ZM6.1518 8.4L10.3938 4.1574L9.5454 3.309L6.1518 6.7032L4.4544 5.0058L3.606 5.8542L6.1518 8.4Z"
                  fill="#38C793"
                />
              </svg>

              <span className="  rounded-full text-sm ml-[7px]">Approved</span>
            </div>
            <div className="col-span-1">
              <button className="text-gray-400 hover:text-gray-600">
                <svg
          ...
          <div className="grid grid-cols-6 p-4 items-center">
            ...
            <div className="col-span-1 flex border px-2 items-center w-[100px] py-1 rounded-lg">
              ...
              >
                <path
                  d="M6.75 12C3.4362 12 0.75 9.3138 0.75 6C0.75 2.6862 3.4362 0 6.75 0C10.0638 0 12.75 2.6862 12.75 6C12.75 9.3138 10.0638 12 6.75 12ZM6.75 5.1516L5.0532 3.4542L4.2042 4.3032L5.9016 6L4.2042 7.6968L5.0532 8.5458L6.75 6.8484L8.4468 8.5458L9.2958 7.6968L7.5984 6L9.2958 4.3032L8.4468 3.4542L6.75 5.1516Z"
                  fill="#DF1C41"
                />
              </svg>

              <span className="  rounded-full text-sm ml-[7px]">Refused</span>
            </div>
            <div className="col-span-1">
              <button className="text-gray-400 hover:text-gray-600">
                <svg
