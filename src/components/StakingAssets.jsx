...
<circle cx="22" cy="22.5" r="21.5" fill="white" stroke="#DCDCDC"/>
<path d="M21.9973 12.2334L21.7729 12.7013V26.2783L21.9973 26.4157L32.2607 22.6905L21.9973 12.2334Z" fill="#343434"/>
<path d="M21.9975 12.2334L11.7339 22.6905L21.9975 26.4157V19.8258V12.2334Z" fill="#8C8C8C"/>
<path d="M21.9975 27.6086L21.8711 27.7033V32.5396L21.9975 32.7662L32.2672 23.8853L21.9975 27.6086Z" fill="#3C3C3B"/>
<path d="M21.9975 32.7662V27.6086L11.7339 23.8853L21.9975 32.7662Z" fill="#8C8C8C"/>
<path d="M21.9976 26.4156L32.261 22.6903L21.9976 19.8257V26.4156Z" fill="#141414"/>
<path d="M11.7339 22.6903L21.9975 26.4156V19.8257L11.7339 22.6903Z" fill="#393939"/>
</svg>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12.8127 11.3495L6.42616 24.7375C6.40186 24.7873 6.39415 24.8435 6.40418 24.898C6.41421 24.9525 6.44143 25.0023 6.48188 25.0402L23.7303 41.5352C23.7793 41.5821 23.8445 41.6083 23.9124 41.6083C23.9803 41.6083 24.0455 41.5821 24.0945 41.5352L41.3429 25.0413C41.3834 25.0033 41.4106 24.9535 41.4206 24.899C41.4306 24.8445 41.423 24.7883 41.3986 24.7385L35.0122 11.3506C34.9915 11.3056 34.9584 11.2675 34.9167 11.2409C34.875 11.2142 34.8264 11.2001 34.7769 11.2002H13.05C13.0002 11.1996 12.9513 11.2134 12.9092 11.2399C12.8671 11.2664 12.8336 11.3045 12.8127 11.3495Z" fill="#50AF95"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M26.1287 26.1123C26.0048 26.1216 25.365 26.1597 23.9379 26.1597C22.8028 26.1597 21.9969 26.1257 21.7141 26.1123C17.3275 25.9197 14.0532 25.1576 14.0532 24.2452C14.0532 23.3328 17.3275 22.5717 21.7141 22.376V25.3533C22.001 25.3739 22.8224 25.4223 23.9575 25.4223C25.3196 25.4223 26.0017 25.3657 26.1245 25.3543V22.3781C30.5019 22.5727 33.7689 23.3348 33.7689 24.2452C33.7689 25.1556 30.5029 25.9177 26.1245 26.1113L26.1287 26.1123ZM26.1287 22.0702V19.406H32.2376V15.3433H15.6052V19.406H21.7131V22.0691C16.7486 22.2967 13.0151 23.2782 13.0151 24.4543C13.0151 25.6303 16.7486 26.6107 21.7131 26.8394V35.3767H26.1276V26.8363C31.0808 26.6087 34.8081 25.6283 34.8081 24.4532C34.8081 23.2782 31.0839 22.2978 26.1276 22.0691L26.1287 22.0702Z" fill="white"/>
</svg>
...
<path d="M23.9036 16.1665H20.6143V22.644H25.7894V25.3561H20.6143V31.8331H24.0648C24.9514 31.8331 31.3434 31.9331 31.3335 24.2971C31.3236 16.6611 25.1339 16.1665 23.9036 16.1665Z" fill="#C2A633"/>
<path d="M23.5 0.5C10.5212 0.5 0 11.0212 0 24C0 36.9788 10.5212 47.5 23.5 47.5C36.4788 47.5 47 36.9788 47 24C47 11.0212 36.4788 0.5 23.5 0.5ZM24.4233 36.6923H15.9128V25.378H12.9128V22.6064H15.9126V11.2914H23.2168C24.9448 11.2914 36.39 10.9326 36.39 24.2042C36.39 37.6953 24.4235 36.6923 24.4235 36.6923H24.4233Z" fill="#C2A633"/>
</svg>
      ...
      <div className="bg-white rounded-xl">
        ...
        <div className="grid grid-cols-6 p-4 border-b bg-[#F9F9FC]">
          ...
          <div className="col-span-1">Earned</div>
          <div className="col-span-1">Requested withdraw</div>
...
<rect width="44" height="44" rx="8" fill="url(#pattern0_214_30397)"/>
<defs>
<pattern id="pattern0_214_30397" patternContentUnits="objectBoundingBox" width="1" height="1">
<use xlink:href="#image0_214_30397" transform="scale(0.0025)"/>
</pattern>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Staked: 1000 USDT</p>
              </div>
            </div>
...
<path d="M6.75 12C3.4362 12 0.75 9.3138 0.75 6C0.75 2.6862 3.4362 0 6.75 0C10.0638 0 12.75 2.6862 12.75 6C12.75 9.3138 10.0638 12 6.75 12ZM7.35 6V3H6.15V7.2H9.75V6H7.35Z" fill="#F27B2C"/>
</svg>
...
<use xlink:href="#image0_214_30397" transform="scale(0.0025)"/>
              ...
              <div>
                <p className="font-medium">Michael Jackson</p>
                <p className="text-sm text-gray-500">Staked: 332 000 Doge</p>
              </div>
            </div>
            <div className="col-span-1">Yesterdar 12:02</div>
            <div className="col-span-1 text-green-500">+320 DOGE</div>
            <div className="col-span-1 text-orange-500">2000 DOGE</div>
            <div className="col-span-1 flex border px-2 items-center w-[110px] py-1 rounded-lg">
            <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<use xlink:href="#image0_214_30397" transform="scale(0.0025)"/>
            ...
            <div className="col-span-1 text-green-500">+320 DOGE</div>
            <div className="col-span-1 text-orange-500">2000 DOGE</div>
            <div className="col-span-1 flex border px-2 items-center w-[100px] py-1 rounded-lg">
            <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M19.4855 6.13794C18.1725 3.93894 15.2254 0.25 10.2504 0.25C5.27536 0.25 2.32825 3.93894 1.01525 6.13794C0.32825 7.28594 0.32825 8.71306 1.01525 9.86206C2.32825 12.0611 5.27536 15.75 10.2504 15.75C15.2254 15.75 18.1725 12.0611 19.4855 9.86206C20.1725 8.71306 20.1725 7.28694 19.4855 6.13794ZM18.1984 9.09204C17.0484 11.018 14.4854 14.25 10.2504 14.25C6.01536 14.25 3.45236 11.019 2.30236 9.09204C1.90036 8.41804 1.90036 7.58098 2.30236 6.90698C3.45236 4.98098 6.01536 1.74902 10.2504 1.74902C14.4854 1.74902 17.0484 4.97998 18.1984 6.90698C18.6014 7.58198 18.6014 8.41804 18.1984 9.09204ZM10.2504 3.75C7.90636 3.75 6.00036 5.657 6.00036 8C6.00036 10.343 7.90636 12.25 10.2504 12.25C12.5944 12.25 14.5004 10.343 14.5004 8C14.5004 5.657 12.5944 3.75 10.2504 3.75ZM10.2504 10.75C8.73336 10.75 7.50036 9.517 7.50036 8C7.50036 6.483 8.73336 5.25 10.2504 5.25C11.7674 5.25 13.0004 6.483 13.0004 8C13.0004 9.517 11.7674 10.75 10.2504 10.75Z" fill="#A0AEC0"/>
        ...
        <div className="flex justify-between items-center p-4 border-t">
          ...
          <div className="flex gap-2">
            <button className="px-2 py-1 border rounded"><svg width="5" height="9" viewBox="0 0 5 9" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.75275 7.84436L0.497754 4.58353C0.389108 4.47423 0.328125 4.32639 0.328125 4.17228C0.328125 4.01817 0.389108 3.87032 0.497754 3.76103L3.75275 0.500196C3.83435 0.417929 3.93859 0.361824 4.05219 0.339033C4.16579 0.316242 4.28361 0.327799 4.39062 0.37223C4.49763 0.41666 4.58898 0.491952 4.65303 0.588505C4.71708 0.685058 4.75093 0.798498 4.75025 0.914363V7.43019C4.75093 7.54606 4.71708 7.6595 4.65303 7.75605C4.58898 7.85261 4.49763 7.9279 4.39062 7.97233C4.28361 8.01676 4.16579 8.02832 4.05219 8.00553C3.93859 7.98273 3.83435 7.92663 3.75275 7.84436Z" fill="#1D1F2C"/>
</svg>
</button>
            <button className="px-2 py-1 bg-gray-900 text-white rounded">1</button>
            ...
            <button className="px-2 py-1 border rounded"><svg width="5" height="9" viewBox="0 0 5 9" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.25 7.42931V0.91231C0.250025 0.796956 0.28425 0.684199 0.348349 0.588293C0.412448 0.492388 0.503543 0.417639 0.610118 0.373498C0.716692 0.329358 0.833961 0.317806 0.9471 0.340304C1.06024 0.362801 1.16417 0.418338 1.24575 0.499894L4.50424 3.75839C4.6136 3.86779 4.67503 4.01613 4.67503 4.17081C4.67503 4.32549 4.6136 4.47384 4.50424 4.58323L1.24575 7.84173C1.16417 7.92328 1.06024 7.97882 0.9471 8.00132C0.833961 8.02381 0.716692 8.01226 0.610118 7.96812C0.503543 7.92398 0.412448 7.84923 0.348349 7.75333C0.28425 7.65742 0.250025 7.54466 0.25 7.42931Z" fill="#1D1F2C"/>
</svg>
</button>
          </div>
        </div>
