            ...
            <tr className="text-left border-b">
              ...
              <th className="pb-4 font-normal text-gray-500">
                <div className="flex items-center justify-between pr-8">
                  <span>User name</span>
                  <svg  width="8" height="10" viewBox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2">
          ...
          <tbody className='bg-white'>
            {users.map((user) => (
              <tr key={user.id} className="border-b">
                <td className="py-4">
                  <input type="checkbox" className="rounded-xl h-[17px] w-[17px]" />
                </td>
                <td className="py-4">
                  <div className="flex items-center gap-3">
                    {user.name === "Miracle Geidt" ? (
                      ...
                      <img src="/path-to-avatar.jpg" alt="" className="w-8 h-8 rounded-full" />
                    )}
                    <div>
                ...
                <td className="py-4 flex items-center space-x-2">
                  <span className={`px-3 py-1 rounded-full text-sm ${
                    user.status === "ACTIVE" ? "bg-[#E7F7EF] font-semibold w-[100px] flex justify-center text-emerald-600" : "bg-[#F4F0FF] font-semibold w-[100px] justify-center text-purple-600"
                  }`}>
                    {user.status}
                  </span>
                  <svg width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M0.528636 1.02876C0.788986 0.768409 1.2111 0.768409 1.47145 1.02876L5.00004 4.55735L8.52864 1.02876C8.78899 0.768409 9.2111 0.768409 9.47145 1.02876C9.7318 1.28911 9.7318 1.71122 9.47145 1.97157L5.47145 5.97157C5.2111 6.23192 4.78899 6.23192 4.52864 5.97157L0.528636 1.97157C0.268287 1.71122 0.268287 1.28911 0.528636 1.02876Z" fill="#A0AEC0"/>
</svg>
        ...
        {users.map((user) => (
          <div key={user.id} className="bg-white p-4 rounded-lg shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`px-3 py-1 rounded-full text-sm ${
                user.status === "ACTIVE" ? "bg-emerald-100 text-emerald-600" : "bg-purple-100 text-purple-600"
              }`}>
                {user.status}
              </span>
            </div>
